...
export const HypnosisSessionScreen = () => {
  const { 
    currentSession, 
    isSessionActive, 
    setSessionActive, 
  ...
  useEffect(() => {
    if (!hypnosisSession && currentSession) {
      console.log('Session d\'hypnose non trouvée:', currentSession);
      setCurrentScreen('hypnosisSelection');
    }
  }, [hypnosisSession, currentSession, setCurrentScreen]);
  ...
  const handleToggleSession = () => {
    if (!isSessionActive) {
      ...
      const breathingPattern = getHypnosisBreathingPattern(currentSession);
