...
export default function FreeSessionRunner() {
  ...
  }, [timeRemaining, isSessionActive, sessionEnding, freeSessionSettings.silentMode, speak, stopAudio, stopBreathing, stopVoice, navigate]);
  ...
  const handleGoBack = () => {
    console.log('Retour à la configuration de session libre');
    setSessionActive(false);
    stopTimer();
    stopBreathing();
    stopAudio();
