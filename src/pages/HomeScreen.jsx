  ...
  return (
    <div className="px-5 pb-5">
      <div className="grid grid-cols-2 gap-4">
        <Link to="/intro/libre" className="home-card bg-gradient-to-r from-pink-500/20 to-purple-500/20 border-2 border-pink-500/30 h-full">
        ...
        <Link to="/intro/guidees" className="home-card bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border-2 border-blue-500/30 h-full">
          <div className="flex flex-col items-center justify-center h-full p-6 text-center">
        ...
        <Link to="/intro/voyage" className="home-card bg-gradient-to-r from-purple-500/20 to-indigo-500/20 border-2 border-purple-500/30 h-full">
          <div className="flex flex-col items-center justify-center h-full p-6 text-center">
        ...
        <Link to="/intro/blog" className="home-card bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-2 border-green-500/30 h-full">
          <div className="flex flex-col items-center justify-center h-full p-6 text-center">
