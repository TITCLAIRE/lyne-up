...
export default function Evolution() {
  ...
  const sessions = [
    { 
      ...
      icon: TrendingUp, 
      time: '3min', 
      desc: 'Progression respiratoire guidée',
      color: 'from-green-500 to-emerald-500' 
    },
    { 
      id: 'freeSessionSelection', 
      icon: Settings, 
      name: 'SESSION LIBRE', 
      time: '3-20min', 
      desc: 'Rythme et durée personnalisables',
  ...
  const handleSessionClick = (session) => {
    if (session.isRedirect) {
      ...
      navigate(`/sessions/run/guided/${session.id}`);
    }
  };
  ...
  return (
    <div className="px-5 pb-5">
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold mb-2">Évolution</h1>
        <p className="text-white/70">Progression et personnalisation</p>
      </div>
